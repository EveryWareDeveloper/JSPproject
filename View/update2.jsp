<%@ page contentType="text/html; charset=EUC-KR" %>
 <jsp:useBean id="bean" scope="session" class="gamestore.BoardBean"/>
<% 
...
<form name="updateFrm" method="post" action="gamestoreUpdate2" enctype="multipart/form-data">
 ...
 <tr>
  <td>
   <table>
	...
	<tr>
     <td colspan="2">
	  <input class="button2" type="button" value="수정완료" onClick="check()">
      <input class="button2" type="reset" value="다시수정"> 
      <input class="button2" type="button" value="뒤로" onClick="history.go(-1)">
	 </td>
    </tr> 
   </table>
  </td>
